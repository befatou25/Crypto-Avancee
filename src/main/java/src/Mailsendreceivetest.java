    ...
    public static void downloadEmailAttachments(String userName, String password) {
        ...
        try {
            ...
            for (int i = 0; i < arrayMessages.length; i++) {
                ...
                if (contentType.contains("multipart")) {
                    ...
                    for (int partCount = 0; partCount < numberOfParts; partCount++) {
                        ...
                        if (Part.ATTACHMENT.equalsIgnoreCase(part.getDisposition())) {
                            ...
                            part.saveFile("C:\\Users\\khawla\\IdeaProjects\\Test_Intellij\\Myfiles" + File.separator + fileName); // le dossier Myfiles à créer dans votre projet
                ...
                int nbr = i+1;
                System.out.println("Message #" + nbr + ":");
